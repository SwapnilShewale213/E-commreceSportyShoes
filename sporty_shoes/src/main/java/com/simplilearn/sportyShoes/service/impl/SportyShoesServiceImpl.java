...
import com.simplilearn.sportyShoes.exceptionHandler.BusinessException;
import com.simplilearn.sportyShoes.model.PurchaseReport;
import com.simplilearn.sportyShoes.model.Shoe;
import com.simplilearn.sportyShoes.repository.PurchaseReportRepository;
import com.simplilearn.sportyShoes.repository.ShoesRepository;
...
public class SportyShoesServiceImpl implements SportyShoesService{
	...
	public void init() {
		...
		Shoe s5=new Shoe(5,"Addidas","Badmintan",3000);
		...
		PurchaseReport pr1 = new PurchaseReport(6,"Kishan","Running",d,"adidas_runner:5,nike_airmax:10");
		PurchaseReport pr2 = new PurchaseReport(7,"Sagar","Cricket",d,"adidas_cricket:5,nike_cricket:10");
		PurchaseReport pr3 = new PurchaseReport(8,"Swapnil","Basketball",d,"adidas_basketball:5,nike_basketball:10");
		PurchaseReport pr4 = new PurchaseReport(9,"Ghanshayam","Football",d,"adidas_football:5,nike_football:10");
		PurchaseReport pr5 = new PurchaseReport(10,"Prem","Badmintan",d,"adidas_Badmintan:10,nike_Badmintan:10");
